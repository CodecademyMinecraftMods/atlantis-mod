...
public class WorldChunkManagerAtlantis extends WorldChunkManager {
	...
	public WorldChunkManagerAtlantis(long seed, WorldType worldtype) {
		this();
	...
	public WorldChunkManagerAtlantis(World world) {
	...
	public BiomeGenBase getBiomeGenAt(int x, int z) {
		...
		if (biome == null)
		{
			return AtlantisMod.atlantisOcean;
		}
